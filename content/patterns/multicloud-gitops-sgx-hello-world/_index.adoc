---
title: Intel SGX protected Multicloud GitOps
date: 2024-02-20
validated: false
...
In the logs of `hello-world-sgx` pod there is information that "Gramine is starting" and it executes the application by printing "HelloWorld!".

...
Gramine Shielded Containres application requires a machine with the same OS as input converted image in order to create SGX convered image. In this case it would be Red Hat Enterprise Linux 8.8. +
